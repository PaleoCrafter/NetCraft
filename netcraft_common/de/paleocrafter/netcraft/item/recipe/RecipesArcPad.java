package de.paleocrafter.netcraft.item.recipe;

import java.util.ArrayList;

import de.paleocrafter.netcraft.item.ItemArcPad;
 ...
 * 
 */
public class RecipesArcPad implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inventoryCrafting, World world) {
        ...
        for (int i = 0; i < inventoryCrafting.getSizeInventory(); ++i) {
            ...
            if (currentStack != null) {
                ...
                if (currentStack.getItem() instanceof ItemArcPad) {
    ...
    public ItemStack getCraftingResult(InventoryCrafting inventoryCrafting) {
        ...
        ItemStack itemStack = null;
        ItemArcPad itemAlchemicalBag = null;
        ...
        for (k = 0; k < inventoryCrafting.getSizeInventory(); ++k) {
            ...
            if (currentStack != null) {
                ...
                if (currentStack.getItem() instanceof ItemArcPad) {
                    ...
                    itemAlchemicalBag = (ItemArcPad) currentStack.getItem();
                    ...
                    float[] dyeColorChannels = EntitySheep.fleeceColorTable[BlockCloth
                            .getBlockFromDye(currentStack.getItemDamage())];
